...
class Auth_model extends CI_Model {
	...
	{
		return $this->db->select("a.*,b.*,a.logo as image,CONCAT_WS(' ', a.first_name, a.last_name) AS fullname,IF (b.user_type=1, 'Admin', 'User') as user_level,b.user_type as user_level2,screen")
			->from('users a')
