   ...
   <div class="panel panel-bd">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="User Id" title="<?php echo display('email') ?>" required="" value="" autocomplete="off" name="email" id="email" class="form-control">
            </div>
            <div class="form-group">
                <label class="control-label" for="password"><?php echo display('password') ?></label>
                <input type="password" title="Please enter your password" placeholder="<?php echo display('password') ?>" required="" value="" autocomplete="off" name="password" id="password" class="form-control">
            </div>
